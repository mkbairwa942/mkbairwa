...
column_list = list(sup_mas_new.columns)
print(column_list)
dtypess = pd.DataFrame(sup_mas_new.dtypes)
#dtypess.columns =['Dtype']
print(dtypess)
# for dfg in column_list:

# dtypee = sup_mas_new.SgCode.dtype
# print(dtypee)
...
class Account_App:
    def __init__(self,root):
        ...
        for col in column_list:
            ...
            print((f'self.{col}=StringVar()'))
            (f'self.{col}=StringVar()')
        ...
        global roww,columnn,padxx,padyy
        roww = 0
        columnn = 0
        padxx = 0
        padyy = 0
        ...
        for col in column_list:
            ...
            print((f'self.lbl_{col}=Label(self.Main_Frame,text="{col}")'))
            print((f'self.lbl_{col}.grid(row={roww},column={columnn},sticky=W,padx=3,pady=1)'))
            print((f'self.entry_{col}=Entry(self.Main_Frame,textvariable=self.{col},font=("arial",9,"bold"),width=15)'))
            print((f'self.entry_{col}.grid(row={roww},column={columnn},sticky=W,padx=3,pady=1)'))

            (f'self.lbl_{col}=Label(self.Main_Frame,text="{col}")')
            (f'self.lbl_{col}.grid(row={roww},column={columnn},sticky=W,padx=3,pady=1)')
            (f'self.entry_{col}=Entry(self.Main_Frame,textvariable=self.{col},font=("arial",9,"bold"),width=15)')
            (f'self.entry_{col}.grid(row={roww},column={columnn},sticky=W,padx=3,pady=1)')
            roww +=1
            columnn +=1


        # self.lbl_SCode=Label(self.Main_Frame,text="SCode")
        # self.lbl_SCode.grid(row=0,column=0,sticky=W,padx=3,pady=1)
        # self.entry_SCode=Entry(self.Main_Frame,textvariable=self.SCode,font=("arial",9,"bold"),width=15)
        # self.entry_SCode.grid(row=0,column=0,sticky=W,padx=3,pady=1)

        # self.lbl_SName_x=Label(self.Main_Frame,text="SName_x")
        # self.lbl_SName_x.grid(row=1,column=1,sticky=W,padx=3,pady=1)
        # self.entry_SName_x=Entry(self.Main_Frame,textvariable=self.SName_x,font=("arial",9,"bold"),width=15)
        # self.entry_SName_x.grid(row=1,column=1,sticky=W,padx=3,pady=1)

        # self.lbl_SgCode=Label(self.Main_Frame,text="SgCode")
        # self.lbl_SgCode.grid(row=2,column=2,sticky=W,padx=3,pady=1)
        # self.entry_SgCode=Entry(self.Main_Frame,textvariable=self.SgCode,font=("arial",9,"bold"),width=15)
        # self.entry_SgCode.grid(row=2,column=2,sticky=W,padx=3,pady=1)

        # self.lbl_CreditDays=Label(self.Main_Frame,text="CreditDays")
        # self.lbl_CreditDays.grid(row=3,column=3,sticky=W,padx=3,pady=1)
        # self.entry_CreditDays=Entry(self.Main_Frame,textvariable=self.CreditDays,font=("arial",9,"bold"),width=15)
        # self.entry_CreditDays.grid(row=3,column=3,sticky=W,padx=3,pady=1)
 
        # self.lbl_AGCode=Label(self.Main_Frame,text="AGCode")
        # self.lbl_AGCode.grid(row=4,column=4,sticky=W,padx=3,pady=1)
        # self.entry_AGCode=Entry(self.Main_Frame,textvariable=self.AGCode,font=("arial",9,"bold"),width=15)
        # self.entry_AGCode.grid(row=4,column=4,sticky=W,padx=3,pady=1)

        # self.lbl_PAGCode=Label(self.Main_Frame,text="PAGCode")
        # self.lbl_PAGCode.grid(row=5,column=5,sticky=W,padx=3,pady=1)
        # self.entry_PAGCode=Entry(self.Main_Frame,textvariable=self.PAGCode,font=("arial",9,"bold"),width=15)
        # self.entry_PAGCode.grid(row=5,column=5,sticky=W,padx=3,pady=1)

        # self.lbl_PGCode=Label(self.Main_Frame,text="PGCode")
        # self.lbl_PGCode.grid(row=6,column=6,sticky=W,padx=3,pady=1)
        # self.entry_PGCode=Entry(self.Main_Frame,textvariable=self.PGCode,font=("arial",9,"bold"),width=15)
        # self.entry_PGCode.grid(row=6,column=6,sticky=W,padx=3,pady=1)
    
        # self.lbl_Add1=Label(self.Main_Frame,text="Add1")
        # self.lbl_Add1.grid(row=7,column=7,sticky=W,padx=3,pady=1)
        # self.entry_Add1=Entry(self.Main_Frame,textvariable=self.Add1,font=("arial",9,"bold"),width=15)
        # self.entry_Add1.grid(row=7,column=7,sticky=W,padx=3,pady=1)
 
        # self.lbl_Add2=Label(self.Main_Frame,text="Add2")
        # self.lbl_Add2.grid(row=8,column=8,sticky=W,padx=3,pady=1)
        # self.entry_Add2=Entry(self.Main_Frame,textvariable=self.Add2,font=("arial",9,"bold"),width=15)
        # self.entry_Add2.grid(row=8,column=8,sticky=W,padx=3,pady=1)

        # self.lbl_Add3=Label(self.Main_Frame,text="Add3")
        # self.lbl_Add3.grid(row=9,column=9,sticky=W,padx=3,pady=1)
        # self.entry_Add3=Entry(self.Main_Frame,textvariable=self.Add3,font=("arial",9,"bold"),width=15)
        # self.entry_Add3.grid(row=9,column=9,sticky=W,padx=3,pady=1)

        # self.lbl_City=Label(self.Main_Frame,text="City")
        # self.lbl_City.grid(row=10,column=10,sticky=W,padx=3,pady=1)
        # self.entry_City=Entry(self.Main_Frame,textvariable=self.City,font=("arial",9,"bold"),width=15)
        # self.entry_City.grid(row=10,column=10,sticky=W,padx=3,pady=1)

        # self.lbl_Pincode=Label(self.Main_Frame,text="Pincode")
        # self.lbl_Pincode.grid(row=11,column=11,sticky=W,padx=3,pady=1)
        # self.entry_Pincode=Entry(self.Main_Frame,textvariable=self.Pincode,font=("arial",9,"bold"),width=15)
        # self.entry_Pincode.grid(row=11,column=11,sticky=W,padx=3,pady=1)
    
        # self.lbl_State=Label(self.Main_Frame,text="State")
        # self.lbl_State.grid(row=12,column=12,sticky=W,padx=3,pady=1)
        # self.entry_State=Entry(self.Main_Frame,textvariable=self.State,font=("arial",9,"bold"),width=15)
        # self.entry_State.grid(row=12,column=12,sticky=W,padx=3,pady=1)
 
        # self.lbl_PanNo=Label(self.Main_Frame,text="PanNo")
        # self.lbl_PanNo.grid(row=13,column=13,sticky=W,padx=3,pady=1)
        # self.entry_PanNo=Entry(self.Main_Frame,textvariable=self.PanNo,font=("arial",9,"bold"),width=15)
        # self.entry_PanNo.grid(row=13,column=13,sticky=W,padx=3,pady=1)
  
        # self.lbl_CstNo=Label(self.Main_Frame,text="CstNo")
        # self.lbl_CstNo.grid(row=14,column=14,sticky=W,padx=3,pady=1)
        # self.entry_CstNo=Entry(self.Main_Frame,textvariable=self.CstNo,font=("arial",9,"bold"),width=15)
        # self.entry_CstNo.grid(row=14,column=14,sticky=W,padx=3,pady=1)

        # self.lbl_GstNo=Label(self.Main_Frame,text="GstNo")
        # self.lbl_GstNo.grid(row=15,column=15,sticky=W,padx=3,pady=1)
        # self.entry_GstNo=Entry(self.Main_Frame,textvariable=self.GstNo,font=("arial",9,"bold"),width=15)
        # self.entry_GstNo.grid(row=15,column=15,sticky=W,padx=3,pady=1)
   
        # self.lbl_OPhone=Label(self.Main_Frame,text="OPhone")
        # self.lbl_OPhone.grid(row=16,column=16,sticky=W,padx=3,pady=1)
        # self.entry_OPhone=Entry(self.Main_Frame,textvariable=self.OPhone,font=("arial",9,"bold"),width=15)
        # self.entry_OPhone.grid(row=16,column=16,sticky=W,padx=3,pady=1)
   
        # self.lbl_RPhone=Label(self.Main_Frame,text="RPhone")
        # self.lbl_RPhone.grid(row=17,column=17,sticky=W,padx=3,pady=1)
        # self.entry_RPhone=Entry(self.Main_Frame,textvariable=self.RPhone,font=("arial",9,"bold"),width=15)
        # self.entry_RPhone.grid(row=17,column=17,sticky=W,padx=3,pady=1)
    
        # self.lbl_Mobile_x=Label(self.Main_Frame,text="Mobile_x")
        # self.lbl_Mobile_x.grid(row=18,column=18,sticky=W,padx=3,pady=1)
        # self.entry_Mobile_x=Entry(self.Main_Frame,textvariable=self.Mobile_x,font=("arial",9,"bold"),width=15)
        # self.entry_Mobile_x.grid(row=18,column=18,sticky=W,padx=3,pady=1)
 
        # self.lbl_Email=Label(self.Main_Frame,text="Email")
        # self.lbl_Email.grid(row=19,column=19,sticky=W,padx=3,pady=1)
        # self.entry_Email=Entry(self.Main_Frame,textvariable=self.Email,font=("arial",9,"bold"),width=15)
        # self.entry_Email.grid(row=19,column=19,sticky=W,padx=3,pady=1)
     
        # self.lbl_Transport=Label(self.Main_Frame,text="Transport")
        # self.lbl_Transport.grid(row=20,column=20,sticky=W,padx=3,pady=1)
        # self.entry_Transport=Entry(self.Main_Frame,textvariable=self.Transport,font=("arial",9,"bold"),width=15)
        # self.entry_Transport.grid(row=20,column=20,sticky=W,padx=3,pady=1)
  
        # self.lbl_BelongsTo=Label(self.Main_Frame,text="BelongsTo")
        # self.lbl_BelongsTo.grid(row=21,column=21,sticky=W,padx=3,pady=1)
        # self.entry_BelongsTo=Entry(self.Main_Frame,textvariable=self.BelongsTo,font=("arial",9,"bold"),width=15)
        # self.entry_BelongsTo.grid(row=21,column=21,sticky=W,padx=3,pady=1)
 
        # self.lbl_IntRate=Label(self.Main_Frame,text="IntRate")
        # self.lbl_IntRate.grid(row=22,column=22,sticky=W,padx=3,pady=1)
        # self.entry_IntRate=Entry(self.Main_Frame,textvariable=self.IntRate,font=("arial",9,"bold"),width=15)
        # self.entry_IntRate.grid(row=22,column=22,sticky=W,padx=3,pady=1)
 
        # self.lbl_DprecBooksPer=Label(self.Main_Frame,text="DprecBooksPer")
        # self.lbl_DprecBooksPer.grid(row=23,column=23,sticky=W,padx=3,pady=1)
        # self.entry_DprecBooksPer=Entry(self.Main_Frame,textvariable=self.DprecBooksPer,font=("arial",9,"bold"),width=15)
        # self.entry_DprecBooksPer.grid(row=23,column=23,sticky=W,padx=3,pady=1)

        # self.lbl_DprecInComeTaxPer=Label(self.Main_Frame,text="DprecInComeTaxPer")
        # self.lbl_DprecInComeTaxPer.grid(row=24,column=24,sticky=W,padx=3,pady=1)
        # self.entry_DprecInComeTaxPer=Entry(self.Main_Frame,textvariable=self.DprecInComeTaxPer,font=("arial",9,"bold"),width=15)
        # self.entry_DprecInComeTaxPer.grid(row=24,column=24,sticky=W,padx=3,pady=1)
   
        # self.lbl_ShowInOS=Label(self.Main_Frame,text="ShowInOS")
        # self.lbl_ShowInOS.grid(row=25,column=25,sticky=W,padx=3,pady=1)
        # self.entry_ShowInOS=Entry(self.Main_Frame,textvariable=self.ShowInOS,font=("arial",9,"bold"),width=15)
        # self.entry_ShowInOS.grid(row=25,column=25,sticky=W,padx=3,pady=1)
  
        # self.lbl_LocalExport=Label(self.Main_Frame,text="LocalExport")
        # self.lbl_LocalExport.grid(row=26,column=26,sticky=W,padx=3,pady=1)
        # self.entry_LocalExport=Entry(self.Main_Frame,textvariable=self.LocalExport,font=("arial",9,"bold"),width=15)
        # self.entry_LocalExport.grid(row=26,column=26,sticky=W,padx=3,pady=1)
 
        # self.lbl_ShrinkPer=Label(self.Main_Frame,text="ShrinkPer")
        # self.lbl_ShrinkPer.grid(row=27,column=27,sticky=W,padx=3,pady=1)
        # self.entry_ShrinkPer=Entry(self.Main_Frame,textvariable=self.ShrinkPer,font=("arial",9,"bold"),width=15)
        # self.entry_ShrinkPer.grid(row=27,column=27,sticky=W,padx=3,pady=1)
     
        # self.lbl_EllongPer=Label(self.Main_Frame,text="EllongPer")
        # self.lbl_EllongPer.grid(row=28,column=28,sticky=W,padx=3,pady=1)
        # self.entry_EllongPer=Entry(self.Main_Frame,textvariable=self.EllongPer,font=("arial",9,"bold"),width=15)
        # self.entry_EllongPer.grid(row=28,column=28,sticky=W,padx=3,pady=1)
   
        # self.lbl_LimitAmount=Label(self.Main_Frame,text="LimitAmount")
        # self.lbl_LimitAmount.grid(row=29,column=29,sticky=W,padx=3,pady=1)
        # self.entry_LimitAmount=Entry(self.Main_Frame,textvariable=self.LimitAmount,font=("arial",9,"bold"),width=15)
        # self.entry_LimitAmount.grid(row=29,column=29,sticky=W,padx=3,pady=1)

        # self.lbl_FabricSecurity=Label(self.Main_Frame,text="FabricSecurity")
        # self.lbl_FabricSecurity.grid(row=30,column=30,sticky=W,padx=3,pady=1)
        # self.entry_FabricSecurity=Entry(self.Main_Frame,textvariable=self.FabricSecurity,font=("arial",9,"bold"),width=15)
        # self.entry_FabricSecurity.grid(row=30,column=30,sticky=W,padx=3,pady=1)
   
        # self.lbl_IgnoreAllSecurity=Label(self.Main_Frame,text="IgnoreAllSecurity")
        # self.lbl_IgnoreAllSecurity.grid(row=31,column=31,sticky=W,padx=3,pady=1)
        # self.entry_IgnoreAllSecurity=Entry(self.Main_Frame,textvariable=self.IgnoreAllSecurity,font=("arial",9,"bold"),width=15)
        # self.entry_IgnoreAllSecurity.grid(row=31,column=31,sticky=W,padx=3,pady=1)

        # self.lbl_PaymentWeek=Label(self.Main_Frame,text="PaymentWeek")
        # self.lbl_PaymentWeek.grid(row=32,column=32,sticky=W,padx=3,pady=1)
        # self.entry_PaymentWeek=Entry(self.Main_Frame,textvariable=self.PaymentWeek,font=("arial",9,"bold"),width=15)
        # self.entry_PaymentWeek.grid(row=32,column=32,sticky=W,padx=3,pady=1)

        # self.lbl_SubAGCode=Label(self.Main_Frame,text="SubAGCode")
        # self.lbl_SubAGCode.grid(row=33,column=33,sticky=W,padx=3,pady=1)
        # self.entry_SubAGCode=Entry(self.Main_Frame,textvariable=self.SubAGCode,font=("arial",9,"bold"),width=15)
        # self.entry_SubAGCode.grid(row=33,column=33,sticky=W,padx=3,pady=1)
 
        # self.lbl_AccountCheck=Label(self.Main_Frame,text="AccountCheck")
        # self.lbl_AccountCheck.grid(row=34,column=34,sticky=W,padx=3,pady=1)
        # self.entry_AccountCheck=Entry(self.Main_Frame,textvariable=self.AccountCheck,font=("arial",9,"bold"),width=15)
        # self.entry_AccountCheck.grid(row=34,column=34,sticky=W,padx=3,pady=1)
 
        # self.lbl_GSTNONEW=Label(self.Main_Frame,text="GSTNONEW")
        # self.lbl_GSTNONEW.grid(row=35,column=35,sticky=W,padx=3,pady=1)
        # self.entry_GSTNONEW=Entry(self.Main_Frame,textvariable=self.GSTNONEW,font=("arial",9,"bold"),width=15)
        # self.entry_GSTNONEW.grid(row=35,column=35,sticky=W,padx=3,pady=1)

        # self.lbl_DiscountPer=Label(self.Main_Frame,text="DiscountPer")
        # self.lbl_DiscountPer.grid(row=36,column=36,sticky=W,padx=3,pady=1)
        # self.entry_DiscountPer=Entry(self.Main_Frame,textvariable=self.DiscountPer,font=("arial",9,"bold"),width=15)
        # self.entry_DiscountPer.grid(row=36,column=36,sticky=W,padx=3,pady=1)

        # self.lbl_STATEOK=Label(self.Main_Frame,text="STATEOK")
        # self.lbl_STATEOK.grid(row=37,column=37,sticky=W,padx=3,pady=1)
        # self.entry_STATEOK=Entry(self.Main_Frame,textvariable=self.STATEOK,font=("arial",9,"bold"),width=15)
        # self.entry_STATEOK.grid(row=37,column=37,sticky=W,padx=3,pady=1)
   
        # self.lbl_STATIONOK=Label(self.Main_Frame,text="STATIONOK")
        # self.lbl_STATIONOK.grid(row=38,column=38,sticky=W,padx=3,pady=1)
        # self.entry_STATIONOK=Entry(self.Main_Frame,textvariable=self.STATIONOK,font=("arial",9,"bold"),width=15)
        # self.entry_STATIONOK.grid(row=38,column=38,sticky=W,padx=3,pady=1)
   
        # self.lbl_SGDESC=Label(self.Main_Frame,text="SGDESC")
        # self.lbl_SGDESC.grid(row=39,column=39,sticky=W,padx=3,pady=1)
        # self.entry_SGDESC=Entry(self.Main_Frame,textvariable=self.SGDESC,font=("arial",9,"bold"),width=15)
        # self.entry_SGDESC.grid(row=39,column=39,sticky=W,padx=3,pady=1)
 
        # self.lbl_GCODE=Label(self.Main_Frame,text="GCODE")
        # self.lbl_GCODE.grid(row=40,column=40,sticky=W,padx=3,pady=1)
        # self.entry_GCODE=Entry(self.Main_Frame,textvariable=self.GCODE,font=("arial",9,"bold"),width=15)
        # self.entry_GCODE.grid(row=40,column=40,sticky=W,padx=3,pady=1)
   
        # self.lbl_AgName=Label(self.Main_Frame,text="AgName")
        # self.lbl_AgName.grid(row=41,column=41,sticky=W,padx=3,pady=1)
        # self.entry_AgName=Entry(self.Main_Frame,textvariable=self.AgName,font=("arial",9,"bold"),width=15)
        # self.entry_AgName.grid(row=41,column=41,sticky=W,padx=3,pady=1)

        # self.lbl_Mobile_y=Label(self.Main_Frame,text="Mobile_y")
        # self.lbl_Mobile_y.grid(row=42,column=42,sticky=W,padx=3,pady=1)
        # self.entry_Mobile_y=Entry(self.Main_Frame,textvariable=self.Mobile_y,font=("arial",9,"bold"),width=15)
        # self.entry_Mobile_y.grid(row=42,column=42,sticky=W,padx=3,pady=1)

        # self.lbl_SName_y=Label(self.Main_Frame,text="SName_y")
        # self.lbl_SName_y.grid(row=43,column=43,sticky=W,padx=3,pady=1)
        # self.entry_SName_y=Entry(self.Main_Frame,textvariable=self.SName_y,font=("arial",9,"bold"),width=15)
        # self.entry_SName_y.grid(row=43,column=43,sticky=W,padx=3,pady=1)
