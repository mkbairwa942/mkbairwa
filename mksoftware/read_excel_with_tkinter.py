...
# def hide_indicate():
#     home_indicate.config(bg='lightblue')
#     menu_indicate.config(bg='lightblue')
#     contact_indicate.config(bg='lightblue')
#     about_indicate.config(bg='lightblue')
...
# def delete_page():
#     for frame in main_framee.winfo_children():
#         frame.destroy()

# options_frame = tk.Frame(root,bg='lightblue')

# home_btn=tk.Button(options_frame,text="Home",font=('Bold',15),fg='#158aff',bg='lightblue',bd=0,command=lambda:indicate(home_indicate,home_page))
# home_btn.place(x=10,y=50)
# home_indicate=tk.Label(options_frame,text='',bg='lightblue')
# home_indicate.place(x=3,y=50,width=5,height=40)

# menu_btn=tk.Button(options_frame,text="Menu",font=('Bold',15),fg='#158aff',bg='lightblue',bd=0,command=lambda:indicate(menu_indicate,menu_page))
# menu_btn.place(x=10,y=100)
# menu_indicate=tk.Label(options_frame,text='',bg='lightblue')
# menu_indicate.place(x=3,y=100,width=5,height=40)

# contact_btn=tk.Button(options_frame,text="Contact",font=('Bold',15),fg='#158aff',bg='lightblue',bd=0,command=lambda:indicate(contact_indicate,contact_page))
# contact_btn.place(x=10,y=150)
# contact_indicate=tk.Label(options_frame,text='',bg='lightblue')
# contact_indicate.place(x=3,y=150,width=5,height=40)

# about_btn=tk.Button(options_frame,text="About",font=('Bold',15),fg='#158aff',bg='lightblue',bd=0,command=lambda:indicate(about_indicate,about_page))
# about_btn.place(x=10,y=200)
# about_indicate=tk.Label(options_frame,text='',bg='lightblue')
# about_indicate.place(x=3,y=200,width=5,height=40)

# options_frame.pack(side=tk.LEFT)
# options_frame.configure(width=100,height=400)

# main_framee=tk.Frame(root,highlightbackground='black',highlightthickness=2)
# main_framee.pack(side=tk.LEFT)
# main_framee.pack_propagate(False)
# main_framee.configure(height=400,width=500)
