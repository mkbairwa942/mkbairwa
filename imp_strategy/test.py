...
def data_download(stk_nm,vol_pr,rsi_up_lvll,rsi_dn_lvll):
    ...
    df = df[(df['Datetime'] <= df_upto_datetime)]
    ...
    df['Buy1'] = np.where((df['Cand_Col'] == "Green") & (df['Buy'] == "Call"),"Call_Buy",np.where((df['Cand_Col'] == "Red") & (df['Buy'] == "Put"),"Put_Buy",""))
    df['Buy2'] = np.where((df['Buy1'] == "Call_Buy") & (df['prev_can_poi'] > 40),"Call_B",np.where((df['Buy1'] == "Put_Buy") & (df['prev_can_poi'] > 40),"Put_B",""))
