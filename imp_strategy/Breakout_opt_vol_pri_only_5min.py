...
while True:
    ...
    for sc in stk_list:
        try:
            ...
            dfgg_up = dfg1[(dfg1["Vol_Price_break"] == "Vol_Pri_break") & (dfg1["Buy/Sell"] != "") & (dfg1["RSI_14"] > 70 ) & (dfg1['PDB'] == "PDHB") & (dfg1["Date"] == current_trading_day.date())]
            ...
            if len(dfgg_up) == 0:
                ...
                Excchh2 = Excchh1[(Excchh1['StrikeRate'] > Closee)]
                ...
                #dfg2['Pdhb_Opt'] = pdhb_opt1
                dfg2['Pdhb_Opt'] = np.where(dfg2['Open'] > pdhb_opt1,"PDHB")
                ...
                if len(dfgg_up_11) == 0:
                    ...
                    print("5 Minute CALL Option Data Scan and Selected "+str(stk_name2)+" ("+str(Scripc)+")")
            ...
            dfgg_dn = dfg1[(dfg1["Vol_Price_break"] == "Vol_Pri_break") & (dfg1["Buy/Sell"] != "") & (dfg1["RSI_14"] < 30 ) & (dfg1['PDB'] == "PDLB") & (dfg1["Date"] == current_trading_day.date())]
            ...
            if len(dfgg_dn) == 0:
                ...
                #dfg2['pdlb_opt1'] = pdlb_opt1
                dfg2['Pdlb_Opt'] = np.where(dfg2['Open'] < pdlb_opt1,"PDLB","")

                five_df7 = pd.concat([dfg2, five_df7])
                ...
                if len(dfgg_dn_11) == 0:
                    ...
                    print("5 Minute Put Option Data Scan and Selected "+str(stk_name2)+" ("+str(Scripc)+")")
    ...
    if five_df1.empty:
        ...
        try:
            five_df1 = five_df1[['Name','Scripcode','Datetime','Date','TimeNow','Open','High','Low','Close','Volume','RSI_14','PDB','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df2.empty:
        ...
        try:
            five_df2 = five_df2[['Name','Scripcode','Datetime','Date','TimeNow','Open','High','Low','Close','Volume','RSI_14','PDB','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df3.empty:
        ...
        try:
            five_df3 = five_df3[['Name','Scripcode','Datetime','Date','TimeNow','Open','High','Low','Close','Volume','RSI_14','PDB','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df4.empty:
        ...
        try:
            five_df4 = five_df4[['Name','Scripcode','Stop_Loss','Add_Till','Buy_At','Target','Term','Datetime','LotSize','Date','TimeNow','Minutes','Open','High','Low','Close','Volume','RSI_14','Pdhb_Opt','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell1','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df7.empty:
        ...
        try:
            five_df7 = five_df7[['Name','Scripcode','Stop_Loss','Add_Till','Buy_At','Target','Term','Datetime','LotSize','Date','TimeNow','Minutes','Open','High','Low','Close','Volume','RSI_14','Pdlb_Opt','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell1','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
            five_df7.sort_values(['Name', 'Datetime'], ascending=[True, False], inplace=True)
            five_delv.range("a:az").value = None
            five_delv.range("a500").options(index=False).value = five_df7
        except Exception as e:
            print(e)
    ...
    if five_df5.empty:
        ...
        try:
            ...
            five_df5 = five_df5[['Name','Scripcode','Stop_Loss','Add_Till','Buy_At','Target','Term','Datetime','LotSize','Date','TimeNow','Minutes','Open','High','Low','Close','Volume','RSI_14','Pdhb_Opt','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell1','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df6.empty:
        ...
        try:
            ...
            five_df6 = five_df6[['Name','Scripcode','Stop_Loss','Add_Till','Buy_At','Target','Term','Datetime','LotSize','Date','TimeNow','Minutes','Open','High','Low','Close','Volume','RSI_14','Pdlb_Opt','Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell1','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
