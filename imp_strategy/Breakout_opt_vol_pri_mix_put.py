...
if not os.path.exists("Breakout_opt_vol_pri_mix_new.xlsx"):
    try:
        ...
        wb.save("Breakout_opt_vol_pri_mix_new.xlsx")
        wb.close()
    except Exception as e:
        print(f"Error : {e}")
        sys.exit()
wb = xw.Book('Breakout_opt_vol_pri_mix_new.xlsx')
        ...
        if market_status2 == "Open":
            ...
            for sc in stk_list:
                try:
                    ...
                    dfgg_up11 = dfg[(dfg["Vol_Price_break"] == "Vol_Pri_break") & (dfg["Buy/Sell"] != "") & (dfg["P_D_H_B"] == "PDHB") &(dfg["RSI_14"] > 50 ) & (dfg['Date'] == curr_day) ]# & (dfg['Close'] > 300)]# & (dfg["Del_Vol_Pri_break"] != "") ]
                    dfgg_dn11 = dfg[(dfg["Vol_Price_break"] == "Vol_Pri_break") & (dfg["Buy/Sell"] != "") & (dfg["P_D_H_B"] == "PDLB") &(dfg["RSI_14"] < 50 ) & (dfg['Date'] == curr_day) ]# & (dfg["Del_Vol_Pri_break"] != "")]
                    ...
                    if len(five_min_list) == 0:
                        ...
                        if five_min_list[0]:
                            ...
                            dfgg_up = dfg1[(dfg1["Vol_Price_break"] == "Vol_Pri_break") & (dfg1["Buy/Sell"] != "") & (dfg1["RSI_14"] > 50 ) & (dfg1["Date"] == current_trading_day.date())]
                            ...
                            if len(dfgg_up) == 0:
                                ...
                                print("5 Min Call Future Data Download and Scan "+str(stk_name)+" ("+str(aa)+")")
                                ...
                                dfgg_up_111 = dfg2[(dfg2["Vol_Price_break"] == "Vol_Pri_break") & (dfg2["Buy/Sell1"] == "Buy_new") & (dfg2["RSI_14"] > 50 ) & (dfg2["Date"] == current_trading_day.date())]
                                five_df5 = pd.concat([dfgg_up_111, five_df5])  

                                dfgg_up_11 = dfg2[(dfg2["Vol_Price_break"] == "Vol_Pri_break") & (dfg2["Buy/Sell1"] == "Buy_new") & (dfg2["RSI_14"] > 50 ) & (dfg2["Date"] == current_trading_day.date()) & (dfg2["Minutes"] < 5 )]
                            ...
                            dfgg_dn = dfg1[(dfg1["Vol_Price_break"] == "Vol_Pri_break") & (dfg1["Buy/Sell"] != "") & (dfg1["RSI_14"] < 50 ) & (dfg1["Date"] == current_trading_day.date())]
                            ...
                            if len(dfgg_dn) == 0:
                                ...
                                print("5 Min Put Future Data Download and Scan "+str(stk_name)+" ("+str(aa)+")")
                                ...
                                dfgg_dn_111 = dfg2[(dfg2["Vol_Price_break"] == "Vol_Pri_break") & (dfg2["Buy/Sell1"] == "Sell_new") & (dfg2["RSI_14"] < 50 ) & (dfg2["Date"] == current_trading_day.date())]
                                five_df6 = pd.concat([dfgg_dn_111, five_df6])

                                dfgg_dn_11 = dfg2[(dfg2["Vol_Price_break"] == "Vol_Pri_break") & (dfg2["Buy/Sell1"] == "Sell_new") & (dfg2["RSI_14"] < 50 ) & (dfg2["Date"] == current_trading_day.date()) & (dfg2["Minutes"] < 5 )]
            ...
            if five_df5.empty:
                ...
                five_df5 = five_df5[['Name','Scripcode','Stop_Loss','Add_Till','Buy_At','Target','Term','Datetime','LotSize','Date','TimeNow','Minutes','Open','High','Low','Close','Volume','RSI_14',	'Price_Chg','Vol_Chg','Vol_Price_break','Buy/Sell1','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
            ...
            if five_df4.empty:
                ...
                not_selected_up = five_df4[(five_df4["Vol_Price_break"] == "Vol_Pri_break") & (five_df4["Buy/Sell1"] == "Buy_new") & (five_df4["RSI_14"] > 50 ) & (five_df4["Date"] == current_trading_day.date())]
                not_selected_dn = five_df4[(five_df4["Vol_Price_break"] == "Vol_Pri_break") & (five_df4["Buy/Sell1"] == "Sell_new") & (five_df4["RSI_14"] < 50 ) & (five_df4["Date"] == current_trading_day.date())]
