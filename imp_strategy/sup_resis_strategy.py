...
# username1 = str(username)
# client = credentials(username1)
users = ["BHAVNA"]#,"MUKESH","HARESH","ALPESH"]
credi_bhav = None
# credi_har = None
# credi_muk = None
# credi_ash = None
...
def data_download(sc,bk_nft_rng_1,bk_nft_rng_2,bk_nft_rng_3,bk_nft_rng_4,bk_nft_rng_5,nft_rng_1,nft_rng_2,nft_rng_3,nft_rng_4,nft_rng_5):
    df = credi_bhav.historical_data('N', 'C', sc, '5m', second_last_trading_day,current_trading_day)
    ...
    df['PUTT'] = np.where(((df['Close'].shift(1) > df['Range_1']) & (df['Close'] < df['Range_1'])) |
                            ((df['Close'].shift(1) > df['Range_2']) & (df['Close'] < df['Range_2'])) |
                            ((df['Close'].shift(1) > df['Range_3']) & (df['Close'] < df['Range_3'])) |
                            ((df['Close'].shift(1) > df['Range_4']) & (df['Close'] < df['Range_4'])) |
...
while True:
    ...
    try:      
        for sc in stk_list:
            ...
            #data_download(sc,bk_nft_rng_1,bk_nft_rng_2,bk_nft_rng_3,bk_nft_rng_4,bk_nft_rng_5,nft_rng_1,nft_rng_2,nft_rng_3,nft_rng_4,nft_rng_5)
            dfg1 = data_download(sc,bk_nft_rng_1,bk_nft_rng_2,bk_nft_rng_3,bk_nft_rng_4,bk_nft_rng_5,nft_rng_1,nft_rng_2,nft_rng_3,nft_rng_4,nft_rng_5) 
            ...
            Put_by_df = dfg1[(dfg1["PUTT"] == "Put_Buy")]
