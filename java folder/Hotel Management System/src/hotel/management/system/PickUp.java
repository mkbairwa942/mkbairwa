...
public class PickUp extends JFrame {
	...
	public PickUp() throws SQLException {
		...
		Image i3 = i1.getImage().getScaledInstance(400, 150,Image.SCALE_DEFAULT);
		ImageIcon i2 = new ImageIcon(i3);
		JLabel l15 = new JLabel(i2);
		l15.setBounds(330,20,400,150);
		add(l15);
		...
		contentPane.add(lblTypeOfCar);
                ...
                c1.setBounds(125, 94, 150, 25);
		contentPane.add(c1);

		JCheckBox checkAvail = new JCheckBox("Only display Available");
		checkAvail.setBounds(125, 150, 205, 23);
        checkAvail.setBackground(Color.WHITE);
		contentPane.add(checkAvail);
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String SQL2 = "select * from driver where available = 'Yes' AND brand = '"+c1.getSelectedItem()+"'";
				try{
