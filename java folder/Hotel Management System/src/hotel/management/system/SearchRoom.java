...
public class SearchRoom extends JFrame {
	...
	public SearchRoom() throws SQLException {
		...
		lblRoomType.setBounds(23, 110, 96, 14);
		contentPane.add(lblRoomType);
		
		JLabel lblRoomAvailable_1 = new JLabel("Availability");
		lblRoomAvailable_1.setBounds(175, 110, 120, 14);
		contentPane.add(lblRoomAvailable_1);
		
		JLabel lblPrice_1 = new JLabel("Price");
		lblPrice_1.setBounds(458, 110, 46, 14);
		contentPane.add(lblPrice_1);
                
        JLabel l1 = new JLabel("Bed Type");
		l1.setBounds(580, 110, 96, 14);
		contentPane.add(l1);
				
		JLabel lblCleanStatus = new JLabel("Clean Status");
		lblCleanStatus.setBounds(306, 110, 96, 14);
