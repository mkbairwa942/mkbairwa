...
while True:
    ...
    for aa in script_list:
        try:
            ...
            #dfg1["Times"] = pd.to_datetime(dfg1["Times"], format='%H:%M:%S')
            ...
            #print(aa)
            dfggg = client.historical_data('N', 'C', aa, '1d', days_365, last_trading_day)      
            dfggg['Scripcode'] = aa
            ...
            if len(dfgg_up_11) == 0:
                ...
                #dfg222.sort_values(['Name', 'Datetime_x'], ascending=[True, True], inplace=True)
    ...
    if five_df1.empty:
        ...
        five_df1 = five_df1[['Name','Scripcode','Date','Times','TimeNow','Open','High','Low','Close','Volume','TGT_SL','RSI_14','Price_Chg','Vol_Chg','Vol_Price_break','O=H=L','Pattern','Buy/Sell','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df2.empty:
        ...
        five_df2 = five_df2[['Name','Scripcode','Date','Times','TimeNow','Minutes','Open','High','Low','Close','Volume',
    ...
    if five_df4.empty:
        ...
        five_df4 = five_df4[['Name','Scripcode','Date','Times','TimeNow','Minutes','Open','High','Low','Close','Volume',
                             'RSI_14','Cand_col','Cand_Body','Top_Wick','Bot_Wick','Cand_Size','Price_Chg','Vol_Chg','Vol_Price_break',                             
                             'Buy_At','Stop_Loss','Add_Till','Target','Term','Filt_Buy_Sell',
                             'O=H=L','Pattern','Buy/Sell','Buy/Sell1','R3','R2','R1','Pivot','S1','S2','S3','Mid_point','CPR','CPR_SCAN','Candle']]
    ...
    if five_df5.empty:
        ...
        #five_df5.sort_values(['Name', 'Date','Times'], ascending=[True, False,False], inplace=True) 
