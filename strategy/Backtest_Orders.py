...
for a in buy_order_list:
    orderboo = buy_order_li[buy_order_li['ScripCode'] == a]
    ...
    # Buy_Type1 = "'"+Buy_Type[1]+"'"
    # print(Buy_Type1)

    print(Buy_Scriptcodee,Buy_Name,Buy_price,Buy_Stop_Loss,Buy_Target,Buy_timee,Buy_Type)

    dfg1 = client.historical_data('N', str(Buy_Type), a, '5m',last_trading_day,current_trading_day) 
    dfg1['Scripcode'] = a
