...
if not os.path.exists("Stocks_Breakout_trial.xlsx"):
    try:
        wb = xw.Book()
        wb.sheets.add("optionchain")
        wb.save("Stocks_Breakout_trial.xlsx")
        wb.close()
    except Exception as e:
        print(f"Error : {e}")
        sys.exit()
wb = xw.Book('Stocks_Breakout_trial.xlsx')
...
while True:
    ...
    # five_df_new1 = pd.read_excel('E:\STOCK\Capital_vercel1\Stocks_Breakout_trial.xlsx', sheet_name='Five_data')
