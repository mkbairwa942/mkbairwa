        ...
        while True: #excel_OC_pro.sheets.active.name in ["Option_Chain_Pro_Input","Option_Chain_Pro_Output"]:
            ...
            if selected_symbol is not None: 
                try: 
                    ...
                    #print(df_oc_ce)
                    df_oc_ce = df_oc_ce [["totalTradedvolume", "change", "lastPrice", "Average_Price", "changeinopeninterest", "openInterest", "strike","BIDQTY","BIDPRICE","ASKPRICE","ASKQTY"]]
                    #print(df_oc_ce)            
                    df_oc_ce = df_oc_ce.rename(columns={"openInterest": "CE_OI", "changeinopeninterest": "CE Change in OI", "lastPrice": "CE LTP", "change": "CE LTP Change", "Average Price": "VWAP", "totalTradedvolume": "CE Volume" ,"BIDQTY" : "CE_BIDQTY","BIDPRICE":"CE_BIDPRICE","ASKPRICE":"CE_ASKPRICE","ASKQTY":"CE_ASKQTY"}) 
                    #print(df_oc_ce)
