...
def start_excel():
    ...
    while True:
        try:
            ...
            bank_nifty = index_frame[(index_frame["Index"] == "NIFTY BANK")]
            bank_nifty = bank_nifty[['identifier','change','pChange','Weitage']]
            st4.range("a1").options(index=False).value = nifty1
            st4.range("f1").options(index=False).value = bank_nifty
